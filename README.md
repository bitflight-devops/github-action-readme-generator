...
One caveat, and it is about the markers rather than the formatter: the tool
pairs the last start marker in the file with the last end marker in the file. If
your README repeats either marker after the real pair — in a fenced example, say
— the tool pairs the wrong two and rewrites the text between them. Keep marker
examples above your generated sections, or quote them inline between backticks,
until
[issue #691](https://github.com/bitflight-devops/github-action-readme-generator/issues/691)
is fixed. Both of those placements are tested and safe.
